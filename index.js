...
sendEphemeral: false,
"externalAdReply": {
                "title": `Whatsapp-BOT\n𝑃𝑢𝑡𝑏𝑜𝑡𝑧. (@nnda.krnwn_) •Instagram photos and Videos`,
                "body": "",
                "previewType": "PHOTO",
...
`
sendButLocation(from, `${menu}`,`ʙᴏᴛ ʙʏ @60147366955`, {jpegThumbnail:iye}, [{buttonId:`command`,buttonText:{displayText:'LIST MENU'},type:1},{buttonId:`credit`,buttonText:{displayText:'THANKS TO'},type:1},{buttonId:`script`,buttonText:{displayText:'SCRIPT'},type:1}], {contextInfo: { mentionedJid: [ptod,stod]}})
